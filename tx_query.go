...
func (self *txQuery) List(targetSlice interface{}) error {
	if self.ql == "" {
	...
	tx := self.tx
	stmt, stmtErr := tx.Prepare(self.ql)
	if stmtErr != nil {
		return stmtErr
	}
	defer stmt.Close()
...
func (self *txQuery) One(target interface{}) error {
...
func (self *txQuery) Int(target *int64) error {
	elementValue := reflect.Indirect(reflect.ValueOf(target))
	return self.loadBasicVariable(elementValue)
}

func (self *txQuery) Float(target *float64) error {
	elementValue := reflect.Indirect(reflect.ValueOf(target))
	return self.loadBasicVariable(elementValue)
}

func (self *txQuery) Bool(target *bool) error {
	elementValue := reflect.Indirect(reflect.ValueOf(target))
	return self.loadBasicVariable(elementValue)
}

func (self *txQuery) Time(target *time.Time) error {
	elementValue := reflect.Indirect(reflect.ValueOf(target))
	return self.loadBasicVariable(elementValue)
}

func (self *txQuery) Bytes(target *[]byte) error {
	elementValue := reflect.Indirect(reflect.ValueOf(target))
	return self.loadBasicVariable(elementValue)
}

func (self *txQuery) String(target *string) error {
	elementValue := reflect.Indirect(reflect.ValueOf(target))
	return self.loadBasicVariable(elementValue)
}

func (self *txQuery) loadInterface(elementValue reflect.Value) error {
...
func (self *txQuery) loadBasicVariable(elementValue reflect.Value) error {
